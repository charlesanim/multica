...
SELECT DISTINCT i.id, i.workspace_id, i.title, i.description, i.status, i.priority, i.assignee_type, i.assignee_id, i.creator_type, i.creator_id, i.parent_issue_id, i.acceptance_criteria, i.context_refs, i.position, i.due_date, i.created_at, i.updated_at, i.number, i.project_id, i.origin_type, i.origin_id FROM issue i
...
func (q *Queries) SearchIssuesByCommentContent(ctx context.Context, arg SearchIssuesByCommentContentParams) ([]Issue, error) {
	rows, err := q.db.Query(ctx, searchIssuesByCommentContent, arg.WorkspaceID, arg.Content)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
